...
<body>
    <?php
         ...
         * array_keys() - возвращает ключи ассоциативного массива
         * array_rand() - возвращает случайный ключ из массива (или массив ключей)
         * array_sum() - сумма численных значений массива
         * explode(separator, $source) - разбивает строку на массив по сепаратору
         *
